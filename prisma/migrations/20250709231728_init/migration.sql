-- CreateEnum
CREATE TYPE "Role" AS ENUM ('ADMIN', 'RESTAURATEUR', 'LIVREUR', 'CLIENT');

-- CreateEnum
CREATE TYPE "OrderStatus" AS ENUM ('REÇU', 'EN_PREPARATION', 'PRET', 'LIVRER', 'ANNULER');

-- CreateEnum
CREATE TYPE "DeliveryStatus" AS ENUM ('EN_ATTENTE', 'ASSIGNER', 'EN_TRANSIT', 'LIVRER', 'ECHEC');
...
CREATE TABLE "Product" (
    ...
    "description" TEXT,
    "imageUrl" TEXT,
    "prixOriginal" DOUBLE PRECISION NOT NULL,
